...
Start-Process -FilePath "msiexec.exe" -ArgumentList "/i `"$destination`" ADDLOCAL=FeatureMain,FeatureEnvironment,FeatureJarFileRunWith,FeatureJavaHome INSTALLDIR=`"c:\Program Files\Temurin`"" /quiet" -Wait